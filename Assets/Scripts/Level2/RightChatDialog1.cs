...
public class RightChatDialog1 : MonoBehaviour
{
    [Header("UI 组件")]
    ...
    void Awake()
    {
        player.GetComponent<JixieshiController>().Frooze();
    ...
    void Update()
    {
        ...
        //}
        //
        if (Input.GetKeyDown(KeyCode.RightShift) && _Index == _TextList.Count)
        {

            player.GetComponent<JixieshiController>().UnFrooze();
